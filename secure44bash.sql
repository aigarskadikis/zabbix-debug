drop database z44;
CREATE DATABASE z44 CHARACTER SET utf8 COLLATE utf8_bin;
GRANT SELECT, UPDATE, DELETE, INSERT, CREATE, DROP, ALTER, INDEX, REFERENCES ON z44.* TO "zabbix"@"10.133.253.43";
exit
zcat /usr/share/doc/zabbix-server-mysql*/create.sql.gz | mysql z44
